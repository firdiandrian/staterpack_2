...
<section class="section">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('admin.product.categories.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Category Product</a>
        </div>
        <div class="card-body">
            <div class="float-right">
                <form id="searchForm" method='GET' action="{{route('admin.product.categories.index')}}">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari Data" name="keyword" value="{{ Request::get('keyword') }}">
                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item" href="{{ route('admin.product.categories.edit', $model->id) }}">Edit</a>

    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin.blog.posts.create') }}" class="btn btn-success pull-right"><i
                ...
                <div class="float-right">
                    <form id="searchForm">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari Data" name="name"
                                value="">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.blog.posts.edit', $model->id) }}">Edit</a>
                                            <form action="{{ route('admin.blog.posts.destroy', $model->id) }}"
                                                method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#searchForm").submit(function(event) {
                ...
                window.location.href = "{{ route('admin.blog.posts.index') }}?name=" + name + "&shortBy=" +
                    shortBy;
            });

...
<section class="section">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('admin.blog.tags.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Blog Tag </a>
        </div>
        <div class="card-body">
            ...
            <div class="float-right">
                <form id="searchForm">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari Data" name="tag" value="">
                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item" href="{{ route('admin.blog.tags.edit', $model->id) }}">Edit</a>
                                    <form action="{{ route('admin.blog.tags.destroy', $model->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}

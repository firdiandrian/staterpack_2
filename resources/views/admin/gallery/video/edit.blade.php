            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" action="{{ route('admin.gallery_video.update', $model->id) }}" method="post">
                        {{ method_field('put') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="url" size="16" type="text" name="url" placeholder="Url of the video from youtube" value="{{ $model->url }}">

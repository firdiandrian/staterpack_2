...
<section class="section">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('admin.social.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Social Media</a>
        </div>
        <div class="card-body">
                ...
                @foreach($models as $key => $model)
                    <tr>
                        ...
                        <td>
                            <b>{{ $model->title }}</b> <br>
                            @php
                                $classes = ['warning', 'success', 'primary', 'info', 'danger', 'dark','secondary' ]
                            @endphp
                            <span
                                class="badge badge-{{ $classes[@$model->id % 7] }}">
                                <a href="{{ @$model->url }}" target="_blank"> 
                                    <span style="color:#fff;">{{ @$model->type }}</span>
                                </a>
                            </span>
                        </td>
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item" href="{{ route('admin.social.edit', $model->id) }}">Edit</a>

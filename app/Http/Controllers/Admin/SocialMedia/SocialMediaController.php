...
class SocialMediaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'type'  => [
                ...
                function ($attribute, $value, $fail) {
                    if (SocialMedia::where('type', $value)->exists()) {
                        $fail("Type $value sudah terpakai.");
                    }
                },
            ],
            'url'   => 'required'
        ...
        return redirect()->route('admin.social.index')->with(['status' => 'success', 'message' => 'Save Successfully']);
    }
    ...
    public function update(Request $request, SocialMedia $social)
    {
        $request->validate([
            ...
            'type'  => [
                'required',
                Rule::unique('social_media')->ignore($social->id),
            ],
            'url'   => 'required'
        ], [
            'type.unique' => 'Type sudah terpakai.'
        ]);
